...
{
	bool copy; //Added: a datamember to check cwhether the user copies or cuts a card
protected:
...
public:
	...
	void ChangePosition(CellPosition pos);
	...
	bool getCopy();
	void setCopy(bool setter);
	virtual void Copy(Card*source)=0;
